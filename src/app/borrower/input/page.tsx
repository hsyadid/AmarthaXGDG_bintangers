...
export default function ManualInputPage() {
  ...
  function handleSave() {
    console.log("Save cashflow", { revenue, expense, selectedDay, inputType, transactions });
            ...
            <div className="flex justify-between items-center gap-1 mb-4">
              {days.map((day, idx) => (
                <button
                  ...
                  className={`w-12 h-12 rounded-full flex flex-col items-center justify-center text-xs transition ${
                    idx === selectedDay
            ...
            <div className="mb-5">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-3 rounded-2xl border-2 transition flex flex-col items-center gap-1 ${
                    inputMethod === "manual"
